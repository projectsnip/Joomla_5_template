...
<body class="t4-error-page">
  <div class="t4-error-msg">
    ...
    <div class="cta-wrap">
       <h3>Resources</h3>
      <a href="https://www.joomlart.com/member/downloads/joomlart/t4/t4-framework" title="<?php echo Text::_('TPL_T4_DOWNLOAD') ?>"><?php echo Text::_('TPL_T4_DOWNLOAD') ?></a>
      <a href="https://www.joomlart.com/documentation/t4-framework" title="<?php echo Text::_('TPL_T4_DOCUMENTATION') ?>"><?php echo Text::_('TPL_T4_DOCUMENTATION') ?></a>
      <a href="https://www.joomlart.com/forums/t/t4-framework" title="<?php echo Text::_('TPL_T4_SUPPORT') ?>"><?php echo Text::_('TPL_T4_SUPPORT') ?></a>
    </div>
  </div>
</body>
</html>
